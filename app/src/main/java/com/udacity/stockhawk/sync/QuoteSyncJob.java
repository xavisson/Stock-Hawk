            ...
            while (iterator.hasNext()) {
                ...
                if (stock.getQuote().getPrice() == null) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(context, context.getString(R.string.error_wrong_quote),
...
//                    List<HistoricalQuote> history = stock.getHistory(from, to, Interval.WEEKLY);
                    ...
                    // Note for reviewer:
                    // Due to the problems with Yahoo API we have commented this line above
                    // and included this one below to fetch the history from MockUtils
